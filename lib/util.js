...
/**
 * Converts ID hex string to GID Buffer.
 */

exports.id2gid = function (gid) {
  return new Buffer(gid, 'hex');
};
...
exports.uri2gid = function (uri) {
  var id = exports.uri2id(uri);
  return exports.id2gid(id);
};
